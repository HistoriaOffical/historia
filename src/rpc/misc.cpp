...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total historia balance of the wallet\n"
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized historia balance of the wallet\n"
...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "historia|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
            "Change debug category on the fly. Specify single category or use comma to specify many.\n"
            "\nExamples:\n"
            + HelpExampleCli("debug", "historia")
            + HelpExampleRpc("debug", "historia,net")
        );
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"historiaaddress\"\n"
            "\nReturn information about the given historia address.\n"
            "\nArguments:\n"
            "1. \"historiaaddress\"     (string, required) The historia address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"historiaaddress\", (string) The historia address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"Hc6hWnwf45zkM888Qi4VP2vRcwFveHGRT4\"")
            + HelpExampleRpc("validateaddress", "\"Hc6hWnwf45zkM888Qi4VP2vRcwFveHGRT4\"")
        );
...
#ifdef ENABLE_WALLET
        // Case 1: Historia address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are historia addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) historia address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"historiaaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"historiaaddress\"  (string, required) The historia address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"Hc6hWnwf45zkM888Qi4VP2vRcwFveHGRT4\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"Hc6hWnwf45zkM888Qi4VP2vRcwFveHGRT4\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"Hc6hWnwf45zkM888Qi4VP2vRcwFveHGRT4\"]}")
        );
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"Hc6hWnwf45zkM888Qi4VP2vRcwFveHGRT4\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"Hc6hWnwf45zkM888Qi4VP2vRcwFveHGRT4\"]}")
        );
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"Hc6hWnwf45zkM888Qi4VP2vRcwFveHGRT4\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"Hc6hWnwf45zkM888Qi4VP2vRcwFveHGRT4\"]}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"Hc6hWnwf45zkM888Qi4VP2vRcwFveHGRT4\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"Hc6hWnwf45zkM888Qi4VP2vRcwFveHGRT4\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"Hc6hWnwf45zkM888Qi4VP2vRcwFveHGRT4\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"Hc6hWnwf45zkM888Qi4VP2vRcwFveHGRT4\"]}")
        );
