...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s historia-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  historia-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded historia transaction") + "\n" +
              "  historia-tx [options] -create [commands]   " + _("Create hex-encoded historia transaction") + "\n" +
              "\n";
