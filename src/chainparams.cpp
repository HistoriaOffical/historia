...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("historia.org", "dnsseed.historia.org"));
        vSeeds.push_back(CDNSSeedData("historiadot.io", "dnsseed.historiadot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("historia.io", "dnsseed.historia.io"));

        // Historia addresses start with 'X'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,76);
        // Historia script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Historia private keys start with '7' or 'X'
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("historiadot.io",  "testnet-seed.historiadot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "test.dnsseed.masternode.io"));

        // Testnet Historia addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Historia script addresses start with '8' or '9'
