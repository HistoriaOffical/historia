    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Historia Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Historia Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  historia-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Historia in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 HTA, 0.1 HTA, 1 HTA and 10 HTA -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://historia.atlassian.net/wiki/display/DOC/PrivateSend\">https://historia.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Historia Core is shutting down...") + "<br /><br />" +
