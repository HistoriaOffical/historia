    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Historia Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Historia address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and historia: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Historia Core"), this);
    aboutAction->setStatusTip(tr("Show information about Historia Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Historia Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Historia addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Historia addresses"));
    ...
    openAction->setStatusTip(tr("Open a historia: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Historia Core help message to get a list with possible Historia Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Historia Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Historia network", "", count));
    } else {
...
{
    QString strTitle = tr("Historia Core"); // default title
