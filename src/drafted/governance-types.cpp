...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "HistoriaNetwork") type = HistoriaNetwork;
    if(strType == "HistoriaNetworkVariable") type = HistoriaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == HistoriaNetwork) s = "HistoriaNetwork";
    if(type == HistoriaNetworkVariable) s = "HistoriaNetworkVariable";
