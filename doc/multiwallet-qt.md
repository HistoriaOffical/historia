...
Only requiring some minor changes is historia.cpp.
...
Changes to historia.cpp
----------------------
historia.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
