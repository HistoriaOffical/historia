...
This mechanism has been integrated into Bitcore-Node-Historia which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/historia/insight-api-historia#web-socket-api](https://github.com/historia/insight-api-historia#web-socket-api)
* API: [https://github.com/historia/insight-api-historia#instantsend-transactions](https://github.com/historia/insight-api-historia#instantsend-transactions)
...
By default, the Historia Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Historia Core daemon:
