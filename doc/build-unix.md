...
-----------------------
Building the dependencies and Historia Core requires some essential build tools and libraries to be installed before.

Run the following commands to install required packages:

##### Debian/Ubuntu:
```bash
$ sudo apt-get install curl build-essential libtool autotools-dev automake pkg-config python3 bsdmainutils cmake sudo libcurl4-openssl-dev libevent-dev
```
...
Add `CC=egcc CXX=eg++ CPP=ecpp` to the dependencies build and the Historia Core build:
```bash
$ cd depends
