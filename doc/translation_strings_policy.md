...
This document provides guidelines for internationalization of the Historia Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `historia_en.ts` remains unchanged.
