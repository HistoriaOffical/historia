...
git clone https://github.com/HistoriaOffical/historia
...
in the Historia Core repository under 'Fetch and create inputs' to install sources which require
...
```bash
    ...
    From https://github.com/HistoriaOffical/historia
...
BTCPATH=/some/root/path/historia
SIGPATH=/some/root/path/historia-detached-sigs
