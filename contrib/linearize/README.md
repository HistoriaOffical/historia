# Linearize
Construct a linear, no-fork, best version of the Historia blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install historia_hash

https://github.com/HistoriaOffical/historia_hash
...
JSON-RPC server. Running `historiad` or `historia-qt -server` will be sufficient.
...
* `input`: historiad blocks/ directory containing blkNNNNN.dat
