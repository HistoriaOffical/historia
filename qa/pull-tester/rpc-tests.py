...
#Set env vars
buildDir = BUILDDIR
if "HTAD" not in os.environ:
    os.environ["HTAD"] = buildDir + '/src/historiad' + EXEEXT
if "HTACLI" not in os.environ:
    os.environ["HTACLI"] = buildDir + '/src/historia-cli' + EXEEXT
...
#    'rpcbind_test.py', #temporary, bug in libevent, see #6655
    ...
    'mempool_packages.py',
    'maxuploadtarget.py',
    # 'replace-by-fee.py', # RBF is disabled in Historia Core
]
